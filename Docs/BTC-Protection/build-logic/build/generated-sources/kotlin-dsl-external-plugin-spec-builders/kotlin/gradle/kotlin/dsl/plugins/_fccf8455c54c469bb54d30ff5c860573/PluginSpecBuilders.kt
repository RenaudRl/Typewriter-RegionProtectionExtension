...
package gradle.kotlin.dsl.plugins._fccf8455c54c469bb54d30ff5c860573
...
/**
 * The `com.jfrog` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComJfrogPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.jfrog`.
 */
internal
val `ComPluginGroup`.`jfrog`: `ComJfrogPluginGroup`
    get() = `ComJfrogPluginGroup`(plugins)


/**
 * The `com.jfrog.artifactory` plugin implemented by [org.jfrog.gradle.plugin.artifactory.ArtifactoryPlugin].
 */
internal
val `ComJfrogPluginGroup`.`artifactory`: PluginDependencySpec
    get() = plugins.id("com.jfrog.artifactory")
...
/**
 * The `org.ajoberstar` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgAjoberstarPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.ajoberstar`.
 */
internal
val `OrgPluginGroup`.`ajoberstar`: `OrgAjoberstarPluginGroup`
    get() = `OrgAjoberstarPluginGroup`(plugins)


/**
 * The `org.ajoberstar.grgit` plugin implemented by [org.ajoberstar.grgit.gradle.GrgitPlugin].
 */
internal
val `OrgAjoberstarPluginGroup`.`grgit`: PluginDependencySpec
    get() = plugins.id("org.ajoberstar.grgit")


/**
 * The `org.cadixdev` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgCadixdevPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.cadixdev`.
 */
internal
val `OrgPluginGroup`.`cadixdev`: `OrgCadixdevPluginGroup`
    get() = `OrgCadixdevPluginGroup`(plugins)


/**
 * The `org.cadixdev.licenser` plugin implemented by [org.cadixdev.gradle.licenser.Licenser].
 */
internal
val `OrgCadixdevPluginGroup`.`licenser`: PluginDependencySpec
    get() = plugins.id("org.cadixdev.licenser")

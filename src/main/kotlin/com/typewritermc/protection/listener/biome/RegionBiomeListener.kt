package com.typewritermc.protection.listener.biome
...
class RegionBiomeListener(
    ...
    fun onRegionEnter(event: ProtectionRegionsEnterEvent) {
        ...
        com.typewritermc.protection.listener.SchedulerCompat.runLater(plugin, player.location, 2L) {
    ...
    private fun findBiomeRegion(regions: Set<RegionModel>): RegionModel? {
        return regions
            .filter { region ->
                region.flags?.any { it.key == RegionFlagKey.BIOME } == true
            }

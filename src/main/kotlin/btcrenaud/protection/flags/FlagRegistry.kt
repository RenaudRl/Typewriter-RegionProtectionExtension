...
class RegionFlagRegistry {
    ...
    companion object {
        ...
        val definitions = mapOf(
            ...
            RegionFlagKey.BTCMOB_SPAWNING to booleanDefinition(
                RegionFlagKey.BTCMOB_SPAWNING,
                "Allow BTCMobs to spawn",
                RegionFlagCategory.COMBAT,
                FlagEvaluationPriority.HIGH,
            ),
            RegionFlagKey.BTCMOB_DAMAGE to booleanDefinition(
                RegionFlagKey.BTCMOB_DAMAGE,
                "Allow BTCMobs to damage entities",
                RegionFlagCategory.COMBAT,
                FlagEvaluationPriority.HIGH,
            ),
        )

...
class WorldEditAdapter {
    ...
    private inner class ModernWorldEditSupport {
        ...
        // Cache resolved methods to avoid repeated reflection lookups
        private val methodCache = ConcurrentHashMap<String, Method>()

        private fun getCachedMethod(clazz: Class<*>, name: String, vararg paramTypes: Class<*>): Method? {
            val cacheKey = "${clazz.name}#$name:${paramTypes.joinToString(",") { it.name }}"

...
class WorldGuardMigrationService(
    ...
    private fun migrateRegion(
        ...
        // Note: The RegionDefinitionEntry must be created manually via the Typewriter panel
        // or via the /tw protection commands. This migration only creates the artifact + shape.
        logger.info(
            "Migrated WorldGuard region '{}' (priority={}, owners={}, members={}, parent={})",
            regionName, data.priority, data.owners.size, data.members.size, data.parent ?: "none"
        )
    }

...
import btc.renaud.protection.entry.region.groupIds
import btc.renaud.protection.entry.region.parentDefinition
...
class RegionRepository(
    ...
    private val changeListeners = java.util.concurrent.CopyOnWriteArrayList<RegionChangeListener>()
    ...
    fun reload() {
        ...
        flagEvaluationService.invalidateAll()
    ...
    fun setFlag(regionId: String, flagKey: RegionFlagKey, rawValue: String) {
        lock.write {
            ...
            val parsed = btc.renaud.protection.flags.parseFlagValue(flagKey, rawValue)
            ...
            regions[regionId] = updated
            flagEvaluationService.invalidate(regionId)
        }

...
import btc.renaud.protection.settings.ProtectionMessageTemplates
...
class FlagInspectionService(
    ...
    private val formatter: RegionInfoFormatter,
) {
    ...
    fun toggle(player: Player): Boolean {
        ...
        val initialSnapshot = settingsRepository.snapshot(player)
    ...
    private inner class InspectionSession(
        ...
        private var task: btc.renaud.protection.listener.SchedulerCompat.TaskHandle? = null
        ...
        fun tick(initialSnapshot: ProtectionSettingsSnapshot? = null) {
            ...
            val snapshot = initialSnapshot ?: settingsRepository.snapshot(player)
        ...
        private fun render(snapshot: ProtectionSettingsSnapshot) {
            ...
            val cache = mutableMapOf<String, List<btc.renaud.protection.flags.FlagResolution>>()
        ...
        private fun resolutionsFor(
            region: RegionModel,
            cache: MutableMap<String, List<btc.renaud.protection.flags.FlagResolution>>,
        ): List<btc.renaud.protection.flags.FlagResolution> = cache.getOrPut(region.regionId) {
        ...
        private fun buildBossText(
            ...
            region: RegionModel,
            resolutions: List<btc.renaud.protection.flags.FlagResolution>,
            index: Int,
            total: Int,
        ): Component {
        ...
        private fun scheduleNext() {
            ...
            task = btc.renaud.protection.listener.SchedulerCompat.runLater(plugin, player.location, delay) { tick() }
        }
